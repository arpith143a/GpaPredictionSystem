...
sem3_pred_list = []
sem4_pred_list = []
with open('graph1.csv', 'rt') as csvfile:
...
print(get_classes(sem1_true_list, sem1_pred_list))
print()
print(get_classes(sem2_true_list, sem2_pred_list))
print()
print(get_classes(sem3_true_list, sem3_pred_list))
print()
print(get_classes(sem4_true_list, sem4_pred_list))

# plt.axis([0,4,0,1])

plt.xticks(np.arange(6), ('0-2.49', '2.5-2.74', '2.75-2.99', '3.0-3.49', '3.5-3.95', '3.96-4.0'))
plt.plot(get_classes(sem1_true_list, sem1_pred_list), '-',  marker='.')
plt.plot(get_classes(sem2_true_list, sem2_pred_list), '--', marker='.')
plt.plot(get_classes(sem3_true_list, sem3_pred_list), '-.', marker='.')
plt.plot(get_classes(sem4_true_list, sem4_pred_list), ':',  marker='.')
plt.show()
